...
--
-- Host: localhost
-- Tempo de geração: 20-Maio-2020 às 04:29
...
--
-- Estrutura da tabela `cardealer_vehicles`
--
...
--
-- Estrutura da tabela `fine_types`
--
...
--
-- Extraindo dados da tabela `fine_types`
--
...
--
-- Estrutura da tabela `rented_vehicles`
--
...
--
-- Estrutura da tabela `user_accounts`
--
...
--
-- Estrutura da tabela `user_contacts`
--
...
--
-- Estrutura da tabela `user_parkings`
--
...
--
-- Estrutura da tabela `vehicle_sold`
--
...
--
-- Extraindo dados da tabela `weashops`
--
...
--
-- Índices para tabela `cardealer_vehicles`
--
...
--
-- Índices para tabela `fine_types`
--
...
--
-- Índices para tabela `rented_vehicles`
--
...
--
-- Índices para tabela `user_accounts`
--
...
--
-- Índices para tabela `user_contacts`
--
...
--
-- Índices para tabela `user_parkings`
--
...
--
-- Índices para tabela `vehicle_sold`
--
ALTER TABLE `vehicle_sold`
  ADD PRIMARY KEY (`plate`);

--
-- Índices para tabela `weashops`
--
...
--
-- AUTO_INCREMENT de tabela `cardealer_vehicles`
--
ALTER TABLE `cardealer_vehicles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `fine_types`
--
ALTER TABLE `fine_types`
...
--
-- AUTO_INCREMENT de tabela `user_accounts`
--
ALTER TABLE `user_accounts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `user_contacts`
--
ALTER TABLE `user_contacts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `user_inventory`
--
ALTER TABLE `user_inventory`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `user_parkings`
--
ALTER TABLE `user_parkings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `weashops`
--
ALTER TABLE `weashops`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
COMMIT;
